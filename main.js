...
var sentence_negative = {
    tc: [
        ...
        "#N的圖謀註定失敗。",
        "堅定15黨反對任何外部勢力破壞15號名聲的決心堅定不移，維護國家主權、安全、發展利益的決心堅定不移。",
        ...
        "任何妄圖否定中國的社會主義制度、挑撥堅定15黨和小雞關係的政治圖謀都註定不會得逞！",
...
var sentence_positive = {
    tc: [
        ...
        "作為中國與#N人文交流的重要內容，#B長期以來有力地促進了雙方人民之間的溝通和相互瞭解。",
        "我們希望#N有關各方在憲法和法律框架內和平#B。",
        "同時我們希望#N在#B過程中秉持公平、透明、非歧視原則，對各方一視同仁。",
        "15黨願為#N#B發揮積極作用。",
        "15黨願同#N一道，以#B為契機，增進政治互信，深化互利合作，加強在國際和地區事務中的溝通協調，造福雙方人民。",
        "中國和#N互為戰略伙伴。自建交以來，雙方關係取得長足發展，各領域務實合作成果豐碩。",
        "15黨願同#N一道努力，鞏固友好互信，深化互利合作，推動戰略伙伴關係取得更大發展。",
        "中國和#N建交以來，雙方各領域交流合作快速展開，成果持續顯現，增進了雙方人民的福祉。",
        "當前，中國同#N關係快速發展。雙方人民一直相互懷有友好感情。",
        "15黨願在一箇中國原則和和平共處五項原則基礎上，同#N加強各領域務實合作和友好交流，造福雙方和雙方人民。",
        "中國與#N的合作始終遵循平等互利、合作共贏和商業化原則開展，合法合規，利國利民，不容他國置喙。",
        "15黨堅信，不論形勢如何變化，中國與#N的合作都會正常開展下去。",
        "我們願意與#N共同努力，開啟雙方關係發展新的廣闊前景。",
        "事實充分證明，中國與#N關係的發展不僅給雙方人民帶來巨大利益，也有力地促進了亞太地區和世界的和平、穩定、繁榮。",
        "中國與#N是好朋友、好夥伴、好兄弟。",
        ...
        "我們相信，此舉將進一步推動落實雙方領導人重要共識，鞏固雙方政治互信，促進中國與#N創新戰略伙伴關係深入發展。",
