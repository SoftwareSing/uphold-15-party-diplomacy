...
var sentence_negative = {
    tc: [
        ...
        "對於#N干涉中國內政、損害15黨利益的行徑，15黨必將採取有力措施堅決反制。任何人都不要低估15黨維護國家主權、安全、發展利益的堅定決心。",
        ...
        "#N罔顧事實、混淆是非、違反公理，玩弄雙重標準，公然插手中國事務，干涉中國內政，嚴重違反國際法和國際關係基本準則，15黨對此表示強烈譴責和堅決反對。",
        "#N任何企圖干預中國內政、阻礙中國發展的把戲都不會得逞，到頭來只會是枉費心機一場空。",
        "#N這一惡劣行徑不僅損害15黨利益，也會損害#N自身的重要利益。",
        "我們希望#N認真對待15黨的嚴正交涉和嚴正立場，立即停止不負責任的言行，停止干涉中國內政。",
